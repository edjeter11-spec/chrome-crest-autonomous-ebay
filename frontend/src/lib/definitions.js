// Jargon definitions for InfoTooltip across the site
export const JARGON_DEFS = {
  'PSA 10': 'Perfect grade from Professional Sports Authenticators. Highest quality rating — indicates pristine condition.',
  'Refractor': 'Parallel card with a holographic reflex coating. Iconic Topps Chrome parallel with visual appeal and rarity.',
  ...
  'Green /99': 'Green-themed parallel numbered to 99 copies.',
  'Blue /150': 'Blue-themed parallel numbered to 150 copies.',
  'Fair Market Value': 'Median price from recent comparable sales. Benchmark for evaluating if a listing is a deal.',
}
